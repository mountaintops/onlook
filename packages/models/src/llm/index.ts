...
export const MODEL_MAX_INPUT_TOKENS = {
    [GOOGLE_MODELS.GEMMA_4_31B]: 262144,
    [GOOGLE_MODELS.GEMMA_4_26B]: 262144,
    [GOOGLE_MODELS.GEMINI_3_1_FLASH_LITE_PREVIEW]: 1000000,
    [GOOGLE_MODELS.GEMINI_3_FLASH]: 1000000,
    [GOOGLE_MODELS.GEMMA_3_27B]: 131072,
...
export const MODEL_MAX_OUTPUT_TOKENS = {
    [GOOGLE_MODELS.GEMMA_4_31B]: 32768,
    [GOOGLE_MODELS.GEMMA_4_26B]: 32768,
    [GOOGLE_MODELS.GEMINI_3_1_FLASH_LITE_PREVIEW]: 8192,
    [GOOGLE_MODELS.GEMINI_3_FLASH]: 8192,
    [GOOGLE_MODELS.GEMMA_3_27B]: 8192,
    [MISTRAL_MODELS.MISTRAL_LARGE_2512]: 8192,
    [MISTRAL_MODELS.MISTRAL_SMALL_2603]: 8192,
    [MISTRAL_MODELS.DEVSTRAL_2512]: 8192,
    [MODAL_MODELS.GLM_5]: 8192,
} as const;
