...
- Use the uploader tool to upload base64 images directly to the project and conversation context.
- Use the base64 tool to decode text or upload images from base64 strings.
